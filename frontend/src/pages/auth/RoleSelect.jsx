    ...
    return (<div className="flex min-h-screen flex-col items-center justify-center bg-surface px-container-padding-mobile py-12">
      <div className="w-full max-w-md text-center">
        ...
        <div className="mt-10 flex flex-col gap-4">
          <Link to="/signup/pet-parent" className="soft-card-shadow flex items-center gap-4 rounded-xl border border-outline-variant bg-surface-container-lowest p-6 text-left transition-colors hover:bg-surface-container-low">
          ...
          <Link to="/signup/provider" className="soft-card-shadow flex items-center gap-4 rounded-xl border border-outline-variant bg-surface-container-lowest p-6 text-left transition-colors hover:bg-surface-container-low">
